...
<head>
  ...
  <title>Forgot Password | {{Config::get('app.title')}}</title>
  <!-- meta info -->
        ...
        <div class="col-md-7">
          <form action="/forgot_password/" method="POST">
            <h3>Password Recovery</h3>
                    <h5>Lupa Password? isi email dan kami akan membantunya. </h5>
                    <hr>
                    <div class="form-group">
                        <label>Email </label>
                        <input type="email" name="email" class="form-control" required="">
                    </div>
                     <input type="submit" value="Minta Password" class="btn btn-primary">
