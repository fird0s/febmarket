                ...
                <div class="col-md-3">
                    <aside class="sidebar-left">
                        <ul class="nav nav-pills nav-stacked nav-arrow">
                            ...
                            <li>
                                <a href="/register/"><i class="fa fa-edit fa-fw"></i> Register</a>
                            </li>
                          ...
                          @if (Session::has('success'))
                           ...
                           @endif
                            <form action="{{{ route('auth_login') }}}" method="POST">
                                ...
                                <a class="pull-right" href="/forgot_password/">Lupa Password?</a>
                                ...
                                <div class="center">
                                    <a href="#" style="background-color: #3a5795; color:white; font-weight: bold;" class="btn btn--block"><span class="fa fa-facebook fa-fw"></span> Login dengan Facebook</a>
                                    <a style="background-color: #55acee; color:white; font-weight: bold;" href="#" class="btn btn--block"><span class="fa fa-twitter fa-fw"></span> Login dengan  Twitter</a>
                                </div>
                            </form>
                        </div>
