...
<html>
<head>
    <title>Tambah Produk | {{Config::get('app.title')}}</title>
    <!-- meta info -->
        ...
        <div class="container">
            <div class="row" >
                <div class="col-md-3">
                  ...
                  <aside class="sidebar-left">
                      <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left">
                          ...
                          <li class="active"><a href="{{{ route('account_add_product') }}}"><i class="fa fa-plus"></i>Tambah Produk</a>
                          </li>
                      </ul>
                  </aside>
                  <aside class="sidebar-left">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        <form method="POST" action="{{{ route('account_add_product') }}}" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <select  name="category" id="category" class="form-control selectpicker" data-live-search="true" title='Pilih Kategori'>
                              @foreach ($category as $data)
                                <option data-icon="fa fa-fw {{{ $data->icon_css_name }}}" value="{{{ $data->id }}}">{{{ $data->category_name }}}</option>
                              @endforeach
                            </select>
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="input-group-addon">Rp.</div>
                            <input class="form-control" id="price" name="price" maxlength="50" placeholder="" type="text"  >
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label for="price">Stok Produk</label>
                                   <input class="form-control" value="3" type="number" name="quantity" min="1" max="100">
                                </div>
                              </div>
                              <div class="col-md-6">
                                <label>Berat Produk</label>
                                <div class="input-group">
                                  <input type="number" name="weight" class="form-control" min="1" max="10000" value="1">
                    ...
                    <div class="form-group center">
                     ...
                     <figure class="note"><strong>Petunjuk: </strong>Anda dapat meng-upload semua gambar sekaligus (<strong>CTRL</strong> untuk menandai)</figure>


                    </div>
                    <div class="form-group" style="margin-left:15px;margin-right:15px;">
                        <label><b>Informasi Produk</b></label>
                        <textarea name="information" rows="6" maxlength="1000" class="form-control ckeditor"></textarea>
                    </div>

                    <div class="form-group" style="margin-left:15px;margin-right:15px;">
                        <label><b>Pengiriman dan Pembayaran</b></label>
                        <textarea name="shipping_payment" rows="3" maxlength="1000" class="form-control ckeditor"></textarea>
                    </div>


                    <input type="submit" style="margin-left:15px" value="Tambah Produk" class="btn btn-primary">
