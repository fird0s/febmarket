...
<html>
<head>
    <title>{{ $selected_category->category_name }} | {{Config::get('app.title')}}</title>
    <!-- meta info -->
                ...
                <div class="col-md-3">
                    <aside class="sidebar-left">
                        <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left">
                            <li><a href="{{ route('home') }}"><i class="fa fa-ticket"></i>All</a></li>
                            @foreach ($category as $data)
                            <li @if($data->slug_url == $selected_category->slug_url) class="active" @endif><a href="{{ route('category', ['slug_url' => $data->slug_url]) }}"><i class="fa {{{ $data->icon_css_name }}}"></i>{{{ $data->category_name }}}</a></li>
                            @endforeach
