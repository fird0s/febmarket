                ...
                <div class="row">
                            ...
                            <ul class="nav nav-pills flexnav" id="flexnav" data-breakpoint="800">
                                ...
                                <li><a>Tentang</a>
                                    <ul>
                                        ...
                                        <li><a href="/page/tentang.html">{{Config::get('app.title')}}</a>
                                        </li>
                                        <li><a href="/page/syarat-dan-ketentuan-layanan.html">Syarat dan Ketentuan Layanan</a>
                                        </li>
                                ...
                                <li><a href="/page/kontak.html">Kontak</a></li>
                    ...
                    <div class="col-md-6">
                        <ul class="login-register">
                            ...
                            <li>
                                <a href="/account/profile/"><i class="fa fa-user"></i>Hi, fird0s Store</a>
                            </li>
                            <li>
                                <a href="/log_out/">
            ...
            <div class="row">
                <div class="col-md-3">
                    <aside class="sidebar-left">
                        <ul class="nav nav-tabs nav-stacked nav-coupon-category nav-coupon-category-left">
                            <li><a href="/beranda/"><i class="fa fa-ticket"></i>All</a></li>
                            @foreach ($category as $data)
                            <li><a href="/category/fashion/"><i class="fa {{{ $data->icon_css_name }}}"></i>{{{ $data->category_name }}}</a></li>
                            @endforeach
                ...
                <div class="col-md-9">
                    ...
                    <div class="text-center">
                        <a href="/beranda/" class="btn btn-primary">Jelajahi Semua Produk !</a>
                    </div>
