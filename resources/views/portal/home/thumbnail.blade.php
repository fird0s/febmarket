                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                       ...
                       <div class="col-md-2 col-md-offset-7">
                           <div class="product-view pull-right">
                               <a class="fa fa-th-large " href="{{ route('home') }}"></a>
                    ...
                    <div class="product-thumb product-thumb-horizontal">
                        <header class="product-header">
                            <img height="200" width="150" style="min-height: 200px;" src="{{{ asset('media/product') }}}/{{ unserialize($data->images)[0] }}" />
                        </header>
                        <div class="product-inner">
                            <h5 class="">{{{ $data->product_name }}}</h5>
                            <div class="product-desciption">
                                {{ strip_tags(str_limit($data->information_product, 30)) }}
                            </div>
                            <br>
                            <ul class="list-inline" style="color: #4d4d4d;">
                            ...
                            <div class="product-meta">
                                <ul class="product-price-list">
                                    <li><span class="product-price">Rp. {{ number_format($data->price_product, 0, ".", ".") }}</span>
                                    </li>
                                </ul>
                                <ul class="product-actions-list">

                                    <li><a href="{{ route('display_product', ['slug' => $data->slug_url]) }}" class="btn btn-sm"><i class="fa fa-bars"></i> Lihat selengkapnya</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
