...
<head>
    <title>FAQ | {{Config::get('app.title')}} </title>
    <!-- meta info -->
                ...
                <div class="col-md-9">
                    <article class="post">
                        <div class="post-inner">
                            <h4 class="post-title">FAQ (Pertanyaan yang sering diajukan)</h4>
                            ...
                            <div class="panel-group" id="accordion">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-19" class="collapsed">Siapa yang dapat mengiklankan di FebMarket?</a></h4>
                                    </div>
                                    <div class="panel-collapse collapse" id="collapse-19">
                                        <div class="panel-body">
                                            <p>Torquent ac cursus venenatis habitasse imperdiet sociis primis nascetur curae taciti faucibus convallis aliquam non cursus cubilia elementum turpis et dictumst magna commodo class hac a aliquam nisi eros magnis ante eros viverra dignissim vulputate ante consectetur sem</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-20" class="collapsed">Apakah FebMarket mendukung rekening bersama? </a></h4>
                                    </div>
                                    <div class="panel-collapse collapse" id="collapse-20">
                                        <div class="panel-body">
                                            <p>Feugiat justo taciti lacinia facilisi cras habitant cursus pretium proin sodales in nibh sed auctor ligula hendrerit leo erat dolor ac enim condimentum venenatis vulputate fames sodales nibh euismod duis dignissim lacus hendrerit</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse-20" class="collapsed">Bagaiaman berbelanja aman di FebMarket? </a></h4>
                                    </div>
                                    <div class="panel-collapse collapse" id="collapse-20">
                                        <div class="panel-body">
                                            <p>Feugiat justo taciti lacinia facilisi cras habitant cursus pretium proin sodales in nibh sed auctor ligula hendrerit leo erat dolor ac enim condimentum venenatis vulputate fames sodales nibh euismod duis dignissim lacus hendrerit</p>
